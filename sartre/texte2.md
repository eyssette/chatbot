...
:::info Points importants du texte 2
@{texte2-points-importants}
:::

\`

1. [Explique moi le point n°1 @point-à-expliquer=1](Texte 2 - explications plus précises)
2. [Explique moi le point n°2 @point-à-expliquer=2](Texte 2 - explications plus précises)
3. [Je veux travailler sur un autre texte](Travailler sur un texte en particulier)

## Texte 2 - explications plus précises
...
`!useLLM`
Je cherche à comprendre le point @{texte2-points-importants} de ce texte de Sartre, extrait de sa conférence _L'existentialisme est un humanisme_.
...
## Texte 2 - poser une question

!Keyboard: true

Quelle est ta question ?

!Next: Texte 2 - réponse à la question de l'élève

## Texte 2 - réponse à la question de l'élève
...
1. [Retour au texte 2](Texte 2)
2. [Je veux travailler sur un autre texte](Travailler sur un texte en particulier)

## Texte 2 - tester sa compréhension

!Keyboard: true

Je vais te proposer une question pour tester ta compréhension du texte 2 (attends un peu, je dois réfléchir avant).



<div class="question-texte2" markdown>
...
- S'il y a une question précédente, change de thème : la question ne doit pas porter sur les mêmes notions et le même point important que la question précédente
   - Question précédente : `@SELECTOR[".question-texte2"]`
...
!Next: Texte 2 - tester sa compréhension - évaluation de la réponse de l'élève

## Texte 2 - tester sa compréhension - évaluation de la réponse de l'élève
