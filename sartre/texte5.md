...
## Texte 5 - explications

Voici les points importants de ce texte :

\`

:::info Points importants du texte 5
...
`!useLLM`
Je cherche à comprendre le point @{texte5-points-importants} de ce texte de Sartre, extrait de sa conférence _L'existentialisme est un humanisme_.
...
## Texte 5 - poser une question

!Keyboard: true

Quelle est ta question ?

!Next: Texte 5 - réponse à la question de l'élève

## Texte 5 - réponse à la question de l'élève
...
1. [Retour au texte 5](Texte 5)
2. [Je veux travailler sur un autre texte](Travailler sur un texte en particulier)

## Texte 5 - tester sa compréhension

!Keyboard: true

Je vais te proposer une question pour tester ta compréhension du texte 5 (attends un peu, je dois réfléchir avant).



<div class="question-texte5" markdown>
...
- S'il y a une question précédente, change de thème : la question ne doit pas porter sur les mêmes notions et le même point important que la question précédente
   - Question précédente : `@SELECTOR[".question-texte5"]`
...
!Next: Texte 5 - tester sa compréhension - évaluation de la réponse de l'élève

## Texte 5 - tester sa compréhension - évaluation de la réponse de l'élève
